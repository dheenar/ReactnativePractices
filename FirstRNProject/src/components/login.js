  ...
  return (
       <View style = {styles.mainViewStyle}>
          ...
          <View style = {styles.viewForLoginAndForgotPasswordStyle}>
              <TouchableOpacity title="Login"  color="blue" style = {styles.loginButtonStyle} onPress= {loginButtonTapped}><Text style = {styles.loginButtonTextStyle}>Login</Text></TouchableOpacity>
              <TouchableOpacity style = {styles.forgotButtonStyle}><Text style = {styles.forgotButtonTextStyle}>Forgot email or password?</Text></TouchableOpacity>
